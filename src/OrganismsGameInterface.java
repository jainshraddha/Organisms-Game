...
/**
 * This is the Game Interface. A Game simulator will implement this interface
 * and will be the starting point of running the game.
 * 
 * @author swapneel
 *
 */
public interface OrganismsGameInterface {
	 ...
	 * 
	 * @return true if the game ended normally, false if exceptions were thrown
